...
<ul>
<li><b>인증의 기본:</b>
비밀번호는 인가자와 침입자를 분리하는 필수 인증 수단임.</li>

<li><b>관리 가이드:</b>
KISA는 영문, 숫자, 특수문자 혼합을 권고하며,
이는 공격 표면을 줄이는 핵심 전략임.</li>
</ul>
...
<li>
<b>무차별 대입(Brute Force):</b>
가능한 조합을 순차 대입하는 공격.
해킹 시간은 <b>N^L</b> 관계를 가짐.
</li>
...
<li>
<b>사전 공격(Dictionary Attack):</b>
통상적인 패턴을 이용한 해킹에 무방비함.
</li>

<li>
<b>보안 피로감:</b>
복잡성 규칙 강요에 따른 사용자의 거부감.
</li>
...
<li>
<b>가이드라인 부재:</b>
무엇이 안전한지에 대한 구체적 기준을 체감할 기회 부족.
</li>
...
<li>
<b>다중 인증(MFA/2FA):</b>
비밀번호 탈취 이후의 2차 방어선 구축.
</li>

<li>
<b>비밀번호 관리자(Password Manager):</b>
복잡한 난수 생성을 자동화하여 인지적 부하 감소.
</li>
...
<li>
<b>Streamlit:</b>
대화형 웹 인터페이스를 통해 사용자가 입력한
비밀번호의 엔트로피를 즉시 계산 및 시각화.
</li>

<li>
<b>GitHub:</b>
오픈소스 기반 코드 형상 관리 및 프로젝트 지속성 확보.
</li>

<li>
<b>패러다임 전환:</b>
단순 암기식 보안 교육을 실시간 피드백 중심의
<b>능동적 체험형 교육</b>으로 전환.
</li>
...
<li>
<b>결론:</b>
현재 입력하신 비밀번호는 위 원칙을 바탕으로 분석되었습니다.
</li>
